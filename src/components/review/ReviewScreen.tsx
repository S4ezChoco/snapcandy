    ...
    >
      ...
      <div className="flex items-center gap-4 mt-10">
        ...
        <button
          ...
          className="rounded-full px-10 py-3 text-base font-semibold bg-accent text-white shadow-lg shadow-accent/30 hover:scale-105 hover:shadow-xl hover:shadow-accent/40 transition-all duration-200 cursor-pointer focus:outline-none focus:ring-2 focus:ring-accent/60 focus:ring-offset-2 focus:ring-offset-dark-teal"
        >
          Looks Good!
        </button>
      </div>
